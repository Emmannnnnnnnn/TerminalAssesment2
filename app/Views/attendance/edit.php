...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Attendance Record</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url('attendance/update/'.$attendance['id']) ?>" method="post">
                                <?= csrf_field() ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="remarks" name="remarks" rows="2"
                                        placeholder="Enter remarks (optional)"><?= old('remarks', $attendance['remarks']) ?></textarea>
                                </div>
